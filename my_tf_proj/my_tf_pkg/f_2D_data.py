...
def save_data_task2():
    ...
    np.savez(file_name, X_train_whole, Y_train_whole, X_train, Y_train, X_cv, Y_cv, X_test, Y_test, X_surf_train,Y_surf_train,Z_surf_train, X_surf_cv,Y_surf_cv,Z_surf_cv, X_surf_test,Y_surf_test,Z_surf_test)
