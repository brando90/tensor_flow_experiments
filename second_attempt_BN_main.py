...
variance = tf.Variable(tf.constant(1.0, shape=[D1]), trainable=False) #non-trainable params
...
layer1 = summated_relu_layer(x,W,b,C,bn_layer=False,beta,gamma,mean,var,phase_train)
y = layer1
